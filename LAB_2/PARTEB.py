...
class PARTEB(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PARTEB", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PARTEB")
        ...
        # Variables
        ##################################################
        self.samp_rate_0 = samp_rate_0 = 12500000/8
        self.Ka = Ka = 1
        self.GTX = GTX = 0
        ...
        self._Fc_range = Range(50000000, 2200000000, 1000000, 400000000, 200)
        ...
        self._Ac_range = Range(0, 2, 1e-1, 0.2, 200)

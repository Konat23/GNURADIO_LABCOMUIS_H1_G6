...
class practica2_LabComu2_G07(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulaciones_digitales", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulaciones_digitales")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica2_LabComu2_G07")
        ...
        # Blocks
        ##################################################
        self._Ka_range = Range(0, 2, 1e-1, 1, 200)
        self._Ka_win = RangeWidget(self._Ka_range, self.set_Ka, "coeficiente sensibilidad", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 2, 1e-1, 1, 200)
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Amplitud de l aportadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 15000, 5e-1, 0, 0)
...
def main(top_block_cls=practica2_LabComu2_G07, options=None):

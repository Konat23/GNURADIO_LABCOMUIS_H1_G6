...
class AsK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._n_range = Range(1, 4, 1, 4, 200)
        ...
        self._ka_win = RangeWidget(self._ka_range, self.set_ka, "ka coeficiente mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ka_win)
        self._fc_range = Range(50e6, 2.2e9, 1e6, 400e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "frec_portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._No_range = Range(0, 300e-3, 10e-3, 0, 200)
        ...
        self._DC_range = Range(-8, 8, 100e-3, -3.5, 200)
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "DC nivel_señal_mod", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 2, 100e-3, 1, 200)

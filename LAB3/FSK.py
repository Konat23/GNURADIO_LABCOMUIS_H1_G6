...
class FSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._n_win = RangeWidget(self._n_range, self.set_n, "num_bps", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._n_win)
        self._kf_range = Range(-2*math.pi, 2*math.pi, 1e-3, math.pi/2, 200)
        self._kf_win = RangeWidget(self._kf_range, self.set_kf, "coeficiente_sensibilidad(Mhz/volt)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._kf_win)
        self._fc_range = Range(50e6, 2.2e9, 1e6, 400e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "fre_portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._No_range = Range(0, 30e-3, 100e-6, 100e-6, 200)
        self._No_win = RangeWidget(self._No_range, self.set_No, "Amplitud_de_ruido", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "nivel_señal_mod", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._B_range = Range(1, 40, 1, 10, 200)
        self._B_win = RangeWidget(self._B_range, self.set_B, "Num_muestras*simbolo", "counter_slider", int, QtCore.Qt.Horizontal)
        ...
        self._kp_win = RangeWidget(self._kp_range, self.set_kp, "coeficiente_sensibilidad", "counter_slider", float, QtCore.Qt.Horizontal)

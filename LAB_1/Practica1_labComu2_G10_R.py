...
class Practica1_labComu2_G10_R(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab_1_Receptor", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab_1_Receptor")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_labComu2_G10_R")
        ...
        self._GRX_range = Range(0, 315e-1, 500e-3, 0, 200)
...
def main(top_block_cls=Practica1_labComu2_G10_R, options=None):

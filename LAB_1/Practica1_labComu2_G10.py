...
class Practica1_labComu2_G10(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Manejo_GNU", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Manejo_GNU")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_labComu2_G10")
        ...
        self._NO_win = RangeWidget(self._NO_range, self.set_NO, "Amplitud de ruido", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Practica1_labComu2_G10, options=None):

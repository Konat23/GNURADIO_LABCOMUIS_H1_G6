...
class lab_0_USRP(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab_0_USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab_0_USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_0_USRP")
        ...
        self._K_real_win = RangeWidget(self._K_real_range, self.set_K_real, "Habilita parte real", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._K_real_win)
        self._K_imag_range = Range(0, 1, 1, 0, 200)
        self._K_imag_win = RangeWidget(self._K_imag_range, self.set_K_imag, "Habilita parte imag", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._GRX_range = Range(0, 31, 50e-2, 0, 200)
        self._GRX_win = RangeWidget(self._GRX_range, self.set_GRX, "Ganancia del RX en dB ", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(K_imag)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(K_real)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 4000, 0.5, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 6000, 0.5, 0, 0)
    ...
    def set_K_imag(self, K_imag):
        self.K_imag = K_imag
        self.blocks_multiply_const_vxx_0_0.set_k(self.K_imag)
...
def main(top_block_cls=lab_0_USRP, options=None):

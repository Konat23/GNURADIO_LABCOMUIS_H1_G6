...
class BER(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._No_range = Range(0, 0.800, 100E-6, 0.708, 200)
        ...
        self._B_win = RangeWidget(self._B_range, self.set_B, "Muestras por simbolo (SPS)", "counter_slider", float, QtCore.Qt.Horizontal)

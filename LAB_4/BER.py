...
class BER(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._No_range = Range(0, 0.800, 100E-6, 0.200, 200)
        ...
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "nivel dc de modulante", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        labels = ['Señal TX', 'Señal RX', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self._B_range = Range(1, 40, 1, 1, 200)
        ...
        self._Ac_win = RangeWidget(self._Ac_range, self.set_Ac, "Amplitud de la carrier", "counter_slider", float, QtCore.Qt.Horizontal)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.samp_rate/2, 10000, window.WIN_HAMMING, 6.76))
